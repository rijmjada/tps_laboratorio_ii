...
{
    public partial class FormBuscarStock : Form
    {
        ...
        public FormBuscarStock()
        {
            InitializeComponent();
        }

        public FormBuscarStock(Deposito<Producto> deposito, Ventas ventas, List<Cliente> clientes)
            : this()
        {
        ...
        private void btn_vender_Click(object sender, EventArgs e)
        {
            if (this.listBox1.SelectedItem is not null)
            {
                ...
                FormVenta frmVenta = new FormVenta(productoSeleccionado, this.deposito, this.ventas, this.clientes);
        ...
        private void EmisionFactura(Factura f)
        {
            if(f is not null)
            {
                ...
                if(rta == DialogResult.Yes)
                {
                    ...
                    FormFactura frmVerFactura = new FormFactura(Factura.NombreFactura);
