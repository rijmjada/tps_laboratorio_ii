...
namespace Entidades
{
    public class Libro : Producto
    {
        ...
        public Libro(int codigo, double precio, EOrigen origen, int paginas, EGeneroLiterario genero, string autor, string titulo)
        ...
        public Libro(double precio, EOrigen origen, int paginas, EGeneroLiterario genero, string autor, string titulo)
            : this(-1, precio, origen, paginas, genero, autor, titulo)
        {
