...
namespace Ormeño.Diego._2A.tp3
{
    public partial class FormVerCliente : Form
    {
        ...
        public FormVerCliente(List<Cliente> clientes) 
            : this()
        {
        ...
        private void btn_modificar_Click(object sender, EventArgs e)
        {
            if (this.clientes.Count > 0)
            {
                FormEditarCliente frmModificar = new FormEditarCliente(this.clientes, clientes[dataGridView_Clientes.CurrentRow.Index]);
